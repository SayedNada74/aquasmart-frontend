                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="card">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs text-[var(--color-text-secondary)] font-bold px-1">{t("عدد الأحواض النشطة", "Active Pond Count")}</label>
                                    <div className="flex gap-2 p-1 bg-[var(--color-bg-input)] border border-[var(--color-border)] rounded-xl">
                                        {[1, 2, 3].map((num) => (
                                            <button
                                                key={num}
                                                onClick={() => setPondCount(num)}
                                            ...
                                            >
                                                {num} {t(num === 1 ? "حوض" : "أحواض", num === 1 ? "Pond" : "Ponds")}
                                            </button>
                                        ))}
                                    </div>
                                    <p className="text-[10px] text-[var(--color-text-muted)] px-1">
                                        {t("يتحكم هذا الخيار في عدد الأحواض المعروضة في لوحة التحكم والتقارير.", "This controls how many ponds are shown in the dashboard and reports.")}
                                    </p>
                                </div>
                                <div className="space-y-1.5">
